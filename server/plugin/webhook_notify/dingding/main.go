...
import (
	"github.com/flipped-aurora/gin-vue-admin/server/plugin/webhook_notify/dingding/global"
	"github.com/flipped-aurora/gin-vue-admin/server/plugin/webhook_notify/dingding/router"
