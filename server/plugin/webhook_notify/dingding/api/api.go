...
import (
	...
	notify_response "github.com/flipped-aurora/gin-vue-admin/server/plugin/webhook_notify/dingding/model/response"
	"github.com/flipped-aurora/gin-vue-admin/server/plugin/webhook_notify/dingding/service"
